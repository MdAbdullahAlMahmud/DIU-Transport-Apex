package com.socalledengineers.diutransportadmin.model;
...
public class BusItem {
    ...
    public BusItem(int id, String name, String starting_time, Double lat, Double lon, String driver_uid, String doc_id, String from, String to, String routes_name, String routes_description, String routes_url, String created_uid, long created_at, List<String> seats) {
        this.id = id;
        this.name = name;
